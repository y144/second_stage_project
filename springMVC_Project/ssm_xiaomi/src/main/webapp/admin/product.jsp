                ...
                <div id="middle">
                    <table class="table table-bordered table-striped">
                        <tr>
                            ...
                            <th>商品数量</th>
                            <th>操作</th>
                        </tr><%--**在这里遍历查找返回的商品集合 取出来的每个商品就是每个p**--%>
                        <c:forEach items="${info.list}" var="p"><%--*分页的时候list集合是放在info里的*--%>
                            <tr>
...
<%--给当前<<添加了一个超链接 调用ajax的方法，传进去的页数是当前页码减一--%>
                                            <span aria-hidden="true">«</span></a>
                                    </li><%--循环从第一页到最后一页，如果选择那一页那么就按照超链接跳转到这一页拿数据并且，这个这个页数的按钮背景颜色变为灰色--%>
                                    ...
                                    <li>
                                        ...
                                        <a href="javascript:ajaxsplit(${info.nextPage})" aria-label="Next"><%--给当前<<添加了一个超链接 调用ajax的方法，传进去的页数是当前页码加1--%>
                                            <span aria-hidden="true">»</span></a>
                                    </li>
